...
" 
" The plugin installed from master uses a newer version of black, that is
" still not on pip. The 19.10b0 release works, but has a marker that starts
" with a lowercase letter. This is fixed in master, but...
